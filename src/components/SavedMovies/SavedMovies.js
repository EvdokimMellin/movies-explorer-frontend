...
export default function SavedMovies(props) {
  return (<main>
    ...
    <MoviesCardList page="saved-movies" cards={props.savedCards} handleSaveMovie={props.handleSaveMovie} handleDeleteMovie={props.handleDeleteMovie} moviesList={props.savedMovies} isLoading={props.isLoading} notFound={props.notFoundSaved} />
    <Footer />
  </main>);
}
